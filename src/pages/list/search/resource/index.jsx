...
const Resource = ({ dispatch, listAndsearchAndResource: { list = [], total = 0 }, loading }) => {
  ...
  useEffect(() => {
    dispatch({
      type: 'listAndsearchAndResource/list',
      payload: {
        current: 0,
        limit: 8,
      },
...
export default connect(({ listAndsearchAndResource, loading }) => ({
  listAndsearchAndResource,
  loading: loading.models.listAndsearchAndResource,
}))(Resource);
